...
/*                设置session过期时间，单位 '秒'
    ...
    @ResponseBody
    public String registerUser(HttpSession ses, @Param("username") String username, @Param("nickname") String nickname, @Param("password") String password, @Param("sex") String sex, @Param("userinfo") String userinfo, HttpSession session) {
